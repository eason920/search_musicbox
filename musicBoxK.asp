...
/*****Variable[XML](global)*****/
	...
	function getContent2(){
		...
		if(contentEn.length == contentTc.length){
			...
			tmpTitle = '<div style="font-family: Helvetica, Arial,\'Microsoft JhengHei\', sans-serif;position:relative;font-size:20px;text-align:center;padding: 0 10px 0 10px;">'+spanWord(title)+'</div>'
			tmpAuthor = '<div style="font-family: Helvetica, Arial,\'Microsoft JhengHei\', sans-serif;position:relative;font-size:20px;text-align:center;margin-top:10px;padding: 0 10px 0 10px;">'+author+'</div>'
			...
			for(i=0;i<contentEn.length;i++){
				...
				var lrcEn = '<div style="font-family: Helvetica, Arial,\'Microsoft JhengHei\', sans-serif;position:relative;font-size:18px;text-align:center;padding: 0 10px 0 10px;">'+spanWord(contentEn[i])+'</div>'
				var lrcTc = '<div style="font-family: Helvetica, Arial,\'Microsoft JhengHei\', sans-serif;position:relative;font-size:13px;text-align:center;margin-top:10px;padding: 0 10px 0 10px;">'+contentTc[i]+'</div>'

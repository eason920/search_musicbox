...
<html lang="en">
  <head>
    ...
    <link href="./css/musicbox_awd.css?<%=Timer()%>" rel="stylesheet" type="text/css"/>
    <link href="../css/awd.css?<%=now()%>" rel="stylesheet" type="text/css"/>
    ...
    <script src="../js/select_awd.js"></script>
  ...
  <body>
    <!--#include virtual="search/common/module_mb_header_for_search.asp"-->
    <div id="wrapperMain">
      <aside>
        <section id="blockLabel">
          <p hidden id="function_id">musicbox</p>
          <!--#include virtual="search/common/menu_search_awd.asp"-->
        </section>
